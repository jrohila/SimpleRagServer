...
/**
 * Maps OpenSearch _search response bodies (as Map) to a list of SearchResultDTOs.
 */
    ...
    public static List<SearchResultDTO> toResults(Map<String, Object> responseBody) {
        ...
        for (Map<String, Object> hit : innerHits) {
            ...
            if (sourceObj instanceof Map) {
                ...
                if (text instanceof String) dto.setText((String) text);

                // Reference details
                ReferenceDTO ref = new ReferenceDTO();
                Object docId = source.get("documentId");
                if (docId instanceof String) ref.setDocumentId((String) docId);
                Object sectionTitle = source.get("sectionTitle");
                if (sectionTitle instanceof String) ref.setSectionTitle((String) sectionTitle);
                Object pageNumber = source.get("pageNumber");
                if (pageNumber instanceof Number) ref.setPageNumber(((Number) pageNumber).intValue());
